...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <center>Validation des missions de vos subordonés :</center>
            ...
            <tr role="row">
                ...
                <th class="sorting" aria-controls="dataTable" rowspan="1" colspan="1"> Montant </th>
                <th class="sorting" aria-controls="dataTable" rowspan="1" colspan="1"> Etat du paiement</th>
            </tr>
            </thead>
            <tbody>
